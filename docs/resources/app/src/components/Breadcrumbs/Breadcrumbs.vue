<template>
  <v-card class="mx-1">
    <v-breadcrumbs v-if="!homePage()" class="mt-8 px-4 py-2" style="margin-top: 74px !important; margin-bottom: 8px !important;" :items="breadcrumbsGen">
...
export default {
  computed: {
    breadcrumbsGen() {
      ...
      breadcrumbs.unshift({text: 'Home', to: '/dashboard'});
      return breadcrumbs;
    }
  },
  methods: {
